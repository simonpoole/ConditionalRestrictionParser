 ...
 * 
 * @see <a href="http://wiki.openstreetmap.org/wiki/Conditional_restrictions">conditional restrictions on the
...
public class Restriction {
    ...
    public String prettyPrint() {
        return value + " @" + System.lineSeparator() + conditions.prettyPrint();
    }
